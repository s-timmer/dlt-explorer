    ...
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-6xl px-6 py-12">
          ...
          <main className="space-y-20">
            ...
            <section id="initiative">
              ...
              <div className="space-y-4 text-sm text-muted-foreground leading-relaxed max-w-2xl">
                <p>
                  ...
                  data loading — 3M+ downloads/month, 5,000+ companies. The commercial
                ...
                <p>
                  ...
                  legible — when discovering data, when something breaks, when you need to trust
                  that the data is fresh. The data catalog is the highest-impact surface to design
                  first.
                </p>
                ...
                <p>
                  ...
                  be composed through Python dependencies. So the challenge: how do you build
                  visual surfaces for a company that&apos;s strategically anti-GUI?
                </p>
                <p>
                  The answer is already in how Python works. When you run{" "}
                  <code className="font-mono text-foreground/80 bg-muted px-1.5 py-0.5 rounded text-xs">
                    df.head()
                  </code>{" "}
                  in a notebook, you get a beautifully rendered HTML table. The visual layer isn&apos;t
                  a separate app — it&apos;s what the code produces. This catalog is the same thing:
                  rendered output with considered design choices. Not a website. Not a dashboard.
                  A data viewer.
                </p>
                ...
                <p>
                  Time to first insight (target: under 30 seconds). Self-serve rate (data questions
                  answered without filing a ticket). Catalog return rate (beating the &lt;20% adoption
                  baseline of standalone catalogs). Entity comprehension (can users correctly
                  identify which datasets belong together).
                </p>
              </div>
            </section>
            ...
            <section id="personas">
              ...
              <div className="space-y-4 text-sm text-muted-foreground leading-relaxed max-w-2xl">
                ...
                <p>
                  The design target for this project is the data scientist — the CTO describes
                  them as &ldquo;a working student who only knows Python, no SQL.&rdquo; They
                  represent the biggest growth vector (more users per company = higher-tier
                  subscriptions) and currently have no designed experience at all.
                </p>
                <p>
                  A key insight from the research: the handoff IS the product. The real value
                  isn&apos;t any single persona&apos;s experience — it&apos;s the seamless
                  transition between them. The data engineer publishes. The data scientist
                  discovers. The security person audits. The catalog is the surface where
                  they all meet.
                </p>
              </div>
            </section>
            ...
            <section id="jobs">
              ...
              <div className="space-y-4 text-sm text-muted-foreground leading-relaxed max-w-2xl">
                <p>
                  Every UI element traces back to a user job. Five primary jobs drive the design:
                </p>
                ...
                <p>
                  Each design decision rests on a testable assumption. These aren&apos;t just
                  rationale — they&apos;re the first-month research programme. Every assumption
                  can be validated through usability testing, A/B tests, or analytics.
                </p>
              </div>
            </section>
            ...
            <section id="decisions">
              ...
              <div className="space-y-4 text-sm text-muted-foreground leading-relaxed max-w-2xl">
                ...
                <p>
                  ...
                  are light backgrounds, proportional fonts, generous whitespace. This isn&apos;t
                  an aesthetic preference — it&apos;s matching the user&apos;s native environment.
                  References: Jupyter notebooks, Observable, Google Colab output cells, Notion
                  databases, dbt docs.
                </p>
                ...
                <p>
                  ...
                  &ldquo;Datasets&rdquo; not &ldquo;tables,&rdquo; &ldquo;records&rdquo; not
                  &ldquo;rows,&rdquo; &ldquo;text&rdquo; not &ldquo;varchar.&rdquo; A data
                  scientist seeing &ldquo;bigint&rdquo; feels like they&apos;ve opened the wrong
                  tool. This is a small change with a large impact on confidence.
                </p>
                ...
                <p>
                  ...
                  through four versions — from flat cards, to nested chips, to tree structures,
                  to the current flat-sibling layout that reflects how dlt actually works.
                </p>
                ...
                <p>
                  ...
                  is useful or junk. Database order showed 6 URL fields first — the interesting
                  data was buried. We built a scoring system: identity fields (number, title, state)
            ...
            <section id="process">
              ...
              <div className="space-y-4 text-sm text-muted-foreground leading-relaxed max-w-2xl">
                ...
                <p>
                  ...
                  AI amplified the thinking — research that might take a week compressed into
                  a weekend — but the design decisions were human-driven.
                </p>
                ...
                <p>
                  The catalog is surface one. The design patterns established here — notebook-native
        ...
        <footer className="mt-20 pt-8 border-t text-sm text-muted-foreground">
          <p>
            Built by Sjors as a weekend design initiative for dltHub.{" "}
